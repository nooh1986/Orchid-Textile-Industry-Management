            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">عرض السدوات في العمل</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <tbody>
                                @foreach ($strings as $string )
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-bs-target="#ending{{ $string->id }}" data-bs-toggle="modal"><i data-feather="edit" class="me-50"></i></a>

                                            <a href="{{ route('string.show' , $string->id ) }}" ><i data-feather="eye" class="me-50"></i></a>
                                        </td>
                                    </tr>
                            
                                    @include('strings.ending')
